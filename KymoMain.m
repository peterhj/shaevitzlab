...
%    end
    ...
    normals = KymoNormals(cell2mat(ROI.Retracts(1,i)), cell2mat(ROI.Ends(1,i)), cell2mat(ROI.Poles(1,i)), cell2mat(ROI.Images(1,i)), Parameters.SgolayHalfWindow, Parameters.NormalHalfWindow);
